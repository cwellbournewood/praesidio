 ...
 */
class PraesidioAppLifecycleListener : AppLifecycleListener {

    private val log = logger<PraesidioAppLifecycleListener>()

    override fun appWillBeClosed(isRestart: Boolean) {
        log.info("Praesidio: app shutting down (restart=$isRestart) — stopping edge proxy")
        try {
