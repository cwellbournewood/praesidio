...
/**
 * "Praesidio: Toggle Edge Proxy" — starts the proxy if stopped, stops
    ...
    override fun actionPerformed(e: AnActionEvent) {
        ...
        ApplicationManager.getApplication().executeOnPooledThread {
            ...
            if (!wasRunning) {
                notify(
                    project,
                    message("praesidio.action.proxy.starting"),
                ...
                when (newState) {
                    ProxyController.ProxyState.RUNNING ->
                        notify(
                            project,
                            message(
                                "praesidio.action.proxy.started",
                    ...
                    ProxyController.ProxyState.STOPPED ->
                        notify(
                            project,
                            message("praesidio.action.proxy.stopped"),
                            NotificationType.INFORMATION,
                        )
