 ...
 *
 * Two slots, both keyed on `Praesidio` service name:
 ...
 * so the OS credential manager UI groups all Praesidio entries
 * together.
 *
 ...
 */
class PraesidioCredentialStore(private val gatewayUrl: String) {
    ...
    companion object {
        const val SERVICE_BASE: String = "Praesidio"
        ...
        @JvmStatic
        fun forCurrent(): PraesidioCredentialStore =
            PraesidioCredentialStore(PraesidioSettings.getInstance().gatewayUrl)
    }
}
