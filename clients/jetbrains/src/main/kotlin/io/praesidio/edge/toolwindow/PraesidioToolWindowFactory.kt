...
/**
 * Factory for the Praesidio tool window. Registered in plugin.xml with
 ...
 * the indexed model.
 */
class PraesidioToolWindowFactory : ToolWindowFactory, DumbAware {

    override fun createToolWindowContent(project: Project, toolWindow: ToolWindow) {
        val panel = PraesidioToolWindowContent(project)
