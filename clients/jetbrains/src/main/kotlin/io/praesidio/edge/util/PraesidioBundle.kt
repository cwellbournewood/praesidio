...
private const val BUNDLE_NAME: @NonNls String = "messages.PraesidioBundle"
 ...
 * Usage:
 * ```
 * PraesidioBundle.message("praesidio.action.scan.empty")
 * PraesidioBundle.message("praesidio.toolwindow.status.gateway", url)
 * ```
 */
object PraesidioBundle : DynamicBundle(BUNDLE_NAME) {
    /**
