package io.section.edge.inspections
...
import io.section.edge.gateway.GatewayService
import io.section.edge.gateway.RecentDecisionsService
import io.section.edge.gateway.ScanRequest
import io.section.edge.gateway.ScanResponse
import io.section.edge.settings.SectionSettings
import io.section.edge.util.Chunker
...
/**
 * Local inspection that surfaces Section gateway findings as IDE
...
class SensitiveDataInspection : LocalInspectionTool() {
    ...
    override fun getGroupDisplayName(): String =
        message("section.inspection.group")

    override fun getDisplayName(): String =
        message("section.inspection.displayName")
    ...
    internal class TokeniseQuickFix(
        ...
        override fun getName(): String =
            message("section.inspection.quickfix.tokenise")

        override fun getFamilyName(): String =
            message("section.inspection.quickfix.tokenise.familyName")
        ...
        override fun applyFix(project: Project, descriptor: ProblemDescriptor) {
            ...
            ApplicationManager.getApplication().executeOnPooledThread {
                ...
                ApplicationManager.getApplication().invokeLater {
                    WriteCommandAction.runWriteCommandAction(project, "Section: Tokenise", null, {
                        val docLen = document.textLength
    ...
    companion object {
        const val SHORT_NAME: String = "SectionSensitiveData"
