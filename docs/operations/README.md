...
- [OIDC integration (overview)](oidc.md) — claim model, role mapping, Keycloak dev overlay
  - [OIDC with Okta](oidc-okta.md)
  - [OIDC with Microsoft Entra ID (Azure AD)](oidc-azuread.md)
  - [OIDC with Google Workspace](oidc-google.md)
- [Observability stack](observability.md) — local Tempo/Loki/Prom/Grafana overlay
