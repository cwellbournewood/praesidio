...
| `dev-keys.sh` | Generates dev-quality random values for `PRAESIDIO_VAULT_KEY`, `PRAESIDIO_FPE_KEY`, `PRAESIDIO_FPE_TWEAK` via `openssl rand`. **Dev only** — production keys come from KMS. |
