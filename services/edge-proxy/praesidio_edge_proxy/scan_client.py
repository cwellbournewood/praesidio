"""HTTP client that talks to the Praesidio gateway.
...
# `praesidio_gateway.anonymize.tokenizer._PLACEHOLDER_RE` and the
...
class GatewayClient:
    ...
    Lifecycle: one instance per :class:`PraesidioAddon`. ``aclose()`` MUST
    ...
    def _headers(self) -> dict[str, str]:
        h = {
            ...
            "user-agent": "praesidio-edge-proxy/0.1.0",
            "x-praesidio-tenant": self.settings.tenant,
        }
