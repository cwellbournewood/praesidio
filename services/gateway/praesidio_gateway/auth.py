...
def resolve_principal(
    ...
    x_tenant: Annotated[str | None, Header(alias="X-Praesidio-Tenant")] = None,
    x_user: Annotated[str | None, Header(alias="X-Praesidio-User")] = None,
    x_groups: Annotated[str | None, Header(alias="X-Praesidio-Groups")] = None,
    x_country: Annotated[str | None, Header(alias="X-Praesidio-Country")] = None,
    x_scopes: Annotated[str | None, Header(alias="X-Praesidio-Scopes")] = None,
    ...
    the operator; the gateway accepts ``X-Praesidio-*`` headers from a
    ...
    # Default-grant: keys configured as admin in PRAESIDIO_ADMIN_API_KEYS get
