"""``praesidio-policy`` — lint & simulation CLI for policy bundles (G9).

Two subcommands::

    praesidio-policy lint   <bundle_dir>
    praesidio-policy test   <bundle_dir>  [--fixtures path/to/cases.yaml]
...
def build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(
        prog="praesidio-policy",
        description="Lint and simulate Praesidio policy bundles.",
    )
