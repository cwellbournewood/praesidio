...
embedding strategy and storage layout — the contract Section enforces
is only:
...
# ``section_gateway.anonymize.tokenizer._PLACEHOLDER_RE`` exactly so
                ...
                VectorDocument(
                    ...
                    metadata={
                        **doc.metadata,
                        ...
                        "section.placeholder_count": len(placeholders),
                    },
                )
            )
